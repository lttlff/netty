		...
		var a = {
			...
			domReady: function() {
				...
				return function(a) {
					...
					if (1 == d.length) if (document.addEventListener) document.addEventListener("DOMContentLoaded", b, !1), window.addEventListener("load", b, !1);
		...
		CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
			...
			setKeystroke: function() {
				for (var a = this.keystrokeHandler.keystrokes, b = CKEDITOR.tools.isArray(arguments[0]) ? arguments[0] : [
					[].slice.call(arguments, 0)], c, d, g = b.length; g--;) {
					c = b[g];
					d = 0;
	...
	(function() {
		function a(a) {
			...
			if (c.config.autoParagraph !== false && k != CKEDITOR.ENTER_BR && f.collapsed && g.equals(e) && !d.block) {
				...
				if (!d.checkForward() || g.checkStartOfBlock() && g.checkEndOfBlock()) {
					...
					if (CKEDITOR.env.ie)(c = c.getFirst(b)) && (c.type == CKEDITOR.NODE_TEXT && CKEDITOR.tools.trim(c.getText()).match(/^(?:&nbsp;| )$/)) && c.remove();
					f.select();
					a.cancel()
				}
			}
		...
		CKEDITOR.editable = CKEDITOR.tools.createClass({
			...
			proto: {
				...
				insertElement: function(a) {
					d(this);
					for (var c = this.editor, g = c.config.enterMode, e = c.getSelection(), f = e.getRanges(), i = a.getName(), k = CKEDITOR.dtd.$block[i], m, n, l, B = f.length - 1; B >= 0; B--) {
						m = f[B];
						if (!m.checkReadOnly()) {
							m.deleteContents(1);
							n = !B && a || a.clone(1);
							var q, z;
							if (k) for (;
							(q = m.getCommonAncestor(0, 1)) && (z = CKEDITOR.dtd[q.getName()]) && (!z || !z[i]);) if (q.getName() in CKEDITOR.dtd.span) m.splitElement(q);
						...
						if (!s || i[s] && !t && (!r || h) && (l.getPosition(m) | CKEDITOR.POSITION_PRECEDING | CKEDITOR.POSITION_IDENTICAL | CKEDITOR.POSITION_IS_CONTAINED) == CKEDITOR.POSITION_PRECEDING + CKEDITOR.POSITION_IDENTICAL + CKEDITOR.POSITION_IS_CONTAINED && (!e.childRule || e.childRule(l))) {
							...
							if (v && ((v.getDtd() || CKEDITOR.dtd.span)[d] || f) && (!e.parentRule || e.parentRule(v))) {
								...
								if (q == CKEDITOR.NODE_TEXT || r || q == CKEDITOR.NODE_ELEMENT && !l.getChildCount()) {
									for (var q = l, w;
									(g = !q.getNext(A)) && (w = q.getParent(), i[w.getName()]) && (w.getPosition(k) | CKEDITOR.POSITION_FOLLOWING | CKEDITOR.POSITION_IDENTICAL | CKEDITOR.POSITION_IS_CONTAINED) == CKEDITOR.POSITION_FOLLOWING + CKEDITOR.POSITION_IDENTICAL + CKEDITOR.POSITION_IS_CONTAINED && (!e.childRule || e.childRule(w));) q = w;
									n.setEndAfter(q)
								}
							} else g = true
						} else g = true;
					...
					getNextRange: function(j) {
						...
						if (l && a.length > 1) {
							...
							if (j) for (var m = 0; a[d + m + 1];) {
								for (var n = l.document, j = 0, i = n.getById(e[m].endNode), n = n.getById(e[m + 1].startNode);;) {
