        ...
        <ul class="nav nav-list accordion-group">
          ...
          <li style="display: list-item;" class="rows" id="estRows">
            ...
            <div class="lyrow ui-draggable"><a href="#close" class="remove label label-important"><i class="icon-remove icon-white"></i>删除</a> <span class="drag label"><i class="icon-move"></i>拖动</span>
              ...
              <div class="view">
              	<form name="test_form" class="form-horizontal" role="form" d_form_group="2">
          ...
          <li style="display: none;" class="boxes" id="elmBase">
            ...
            <c:forEach var="field" items="${feildList}" >  
	            <div class="box box-element ui-draggable">
					...
					<div class="preview">${field.label}</div>
					<div class="view">
						<div class="control-group">
		                    <label class="control-label" for="${field.name}" contenteditable="true">${field.label}</label>
		                    <div class="controls">
		                      <input id="${field.name}" name="${field.name}" field_attr="${field.id}" type="text">
		                    </div>
		                </div>
					</div>
				</div>
			...
			<div class="box box-element ui-draggable">
				...
				<div class="preview">销售品编码</div>
				<div class="view">
					<div class="control-group">
	                   	<label class="control-label"  for="offer_nbr" contenteditable="true">销售品编码</label>
	                    <div class="controls">
	                      <input id="offer_nbr" name="offer_nbr" d_field_id="2" type="text">
	                    </div>
	                </div>
				</div>
			</div>
			<div class="box box-element ui-draggable" >
				<a href="#close" class="remove label label-important">
				<i class="icon-remove icon-white"></i>删除</a><span class="drag label">
				<i class="icon-move"></i>拖动</span><span class="configuration"></span>
				<span class="configuration">
					<button type="button" class="btn btn-mini" data-target="#editorModal" role="button" data-toggle="modal">编辑</button></span>
				<div class="preview">邮箱</div>
				<div class="view">
					<div class="control-group">
	                    <label class="control-label" for="inputEmail" contenteditable="true">邮箱</label>
	                    <div class="controls">
	                      <input id="inputEmail" placeholder="Email"  d_field_id="3" type="text">
	                    </div>
	                  </div>
				</div>
			</div>
			<div class="box box-element ui-draggable">
				...
				<span class="drag label"><i class="icon-move"></i>拖动</span><span class="configuration"></span>
				<span class="configuration">
					<button type="button" class="btn btn-mini" data-target="#editorModal" role="button" data-toggle="modal">编辑</button>
				</span>
				<div class="preview">密码</div>
				<div class="view">
					<div class="control-group">
	                   	<label class="control-label"  for="password" contenteditable="true">密码</label>
	                    <div class="controls">
	                      <input id="password" class="form-control" placeholder="密码" d_field_id="4" type="text">
	                    </div>
	                </div>
				</div>
			</div>
