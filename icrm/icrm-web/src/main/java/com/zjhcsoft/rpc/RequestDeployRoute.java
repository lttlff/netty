...
public class RequestDeployRoute {
	 ...
	 * @return
	 */
	public static ResponseContext call(String appName,String className,String methodName,Map<Object,Object> paramMap,User user){
		if(paramMap==null){
			paramMap = new HashMap<Object,Object>();
		}
		paramMap.put(UserSession.USER_SESSION_ID, user);
		return call(appName,className, methodName, paramMap);
	}
