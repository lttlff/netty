...
public class Page implements Serializable {
	...
	private static final long serialVersionUID = -2778322538596780820L;
	...
	private Boolean sort = Boolean.valueOf(false);
	...
	private Long getTotalPage(Long totalRecords) {
		...
		this.everyPage = Long.valueOf(this.everyPage == null ? 10L
